...
all: ../doom_rv32i/src/emdoom
	...
	gcc -O3 -Wno-unused-parameter -Wall -Werror -Wextra -Wshadow -Wcast-align -Wpointer-arith -Wmissing-prototypes -Wmissing-declarations -Wwrite-strings -Wredundant-decls -Wnested-externs -Winline -Wno-long-long -Wconversion -Wstrict-prototypes -lelf src/*.c -o emu_rv32i -lglfw -lGL
